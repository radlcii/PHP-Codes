<!--
    ...
    This exercise was to learn how to gather folder contents from the file system, ideally to be saved to a file, manually copy/pasted to, 
    or (ideally) automatically added to a mysql database, which can be later retrieved as automatically generated hyperlinks. 
    (A kind of self-filling gallery web page)
